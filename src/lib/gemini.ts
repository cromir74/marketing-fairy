...
■ 검증 10: 날씨 온도 언급 금지 (감성으로 대체)
글 안에 구체적인 기온(예: '6도', '20도' 등)이 포함되었는가? 기온 정보는 부정확할 수 있으므로 절대 숫자(숫자+도)를 쓰지 마. 
대신 [현재 상황 정보]의 날씨/체감을 참고해 '어깨가 움츠러드네요', '땀이 송골송골 맺히는 날씨', '따뜻한 온기가 생각나는 쌀쌀함' 등 신체적/감각적 표현으로 100% 대체해.

[검증 순서]
생성 → 검증1~10 순서대로 → 하나라도 실패 시 해당 문장 수정 → 전부 통과 시 출력`;
