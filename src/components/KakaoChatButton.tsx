...
export default function KakaoChatButton() {
    return (
        <a
            ...
            className="fixed bottom-[80px] md:bottom-6 right-2 md:right-6 z-[100] w-14 h-14 bg-[#FEE500] hover:bg-[#F4DC00] text-[#391B1B] rounded-full shadow-lg flex items-center justify-center transition-transform hover:scale-110 active:scale-95 group"
