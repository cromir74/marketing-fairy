...
function PaymentSuccessContent() {
    ...
    useEffect(() => {
        ...
        async function activateSubscription() {
            ...
            try {
                ...
                if (!billingRes.ok) throw new Error(billingData.error || "빌링키 발급에 실패했습니다.");
                ...
                if (!confirmRes.ok) throw new Error(confirmData.error || "결제 승인에 실패했습니다.");
    ...
    }, [authKey, customerKey, plan, refresh]);
    ...
    if (status === "error") {
        return (
            <div className="min-h-[80vh] flex flex-col items-center justify-center p-4 space-y-8 animate-in fade-in duration-500">
                ...
                <Button
                    size="lg"
                    className="w-full max-w-xs h-14 bg-gray-900 hover:bg-black text-white font-bold rounded-2xl"
